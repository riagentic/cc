 ...
 */
import { onCleanup, onMount, signal, type VNode } from "aio/air";
...
export function showToast(
  ...
  // `setTimeout` rather than a scheduled effect: this is a fact about a
  // browser window, not about application state, and it must not exist at all
  // on the server side of a cell.
